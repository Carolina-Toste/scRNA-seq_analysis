...
-   While not always recommended for sc-Seq data, CPM (Counts Per Million) and TPM (Transcripts Per Million) are used by the R pipeline developed by Takara [Hanata](https://www.takarabio.com/documents/User%20Manual/hanta%20R%20kit%20v1.0%20User%20Guide/hanta%20R%20kit%20v1.0%20User%20Guide_060719.pdf) and Ata/Mateus to normalise the data.
